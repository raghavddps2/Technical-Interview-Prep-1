...
for i in range(int(sys.argv[1])):
    ...
    # cv2.rectangle(imgCanvas, (int(0.19 * Width), int(.19 * Height)), (int(0.81 * Width), int(0.81 * Height)), (0, 0, 0),
    #               1)
    ...
    # cv2.rectangle(imgCanvas, (int(0.02 * Width), int(.82 * Height)), (int(0.72 * Width), int(0.97 * Height)), (0, 0, 0),
    #               2)
    # # print(imgBc.shape)
    # # Place image at these coordinates
    ...
    imgPropResize = cv2.resize(imgBc, (int(0.8 * Width) - int(0.2 * Width), int(0.17 * Height) - int(0.04 * Height)))
    ...
    cv2.rectangle(imgCanvas, (int(0.82 * Width), int(.19 * Height)), (int(0.97 * Width), int(0.65 * Height)), (0, 0, 0),
                  2)
    # Place image at these coordinates
    ...
    imgPropResize1 = cv2.resize(imgPropResize1,
    ...
    # # cv2.rectangle(imgCanvas, (int(0.03 * Width), int(.19 * Height)), (int(0.18 * Width), int(0.65 * Height)), (0, 0, 0),
    # #               2)
    # # # Place image at these coordinates
